...
console.log("ActivitiesController file loaded");
module.exports = App.ActivitiesController = Ember.ArrayController.extend({
    
	init: function() {
		console.log ("ActivitiesController instantiated!");
	},
